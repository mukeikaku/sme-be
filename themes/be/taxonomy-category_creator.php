    ...
    <div class="body">
      <div class="wrap">
        <div class="category-list">
          <span class="cat-btn cat-btn-all"><a href="<?php echo esc_url( home_url( '/creator/' ) ); ?>">すべて</a></span>
          ...
          <?php $tslug = $term->slug; ?>
          <?php $tname = $term->name; ?>
          <span class="cat-btn cat-btn-<?php echo $tid; ?><?php if(is_tax('category_creator',$tslug)) : ?> current<?php endif; ?>"><a href="<?php echo get_term_link( $term ); ?>"><?php echo $tname; ?></a></span>  
          <?php } ?>
        </div>
          ...
          <li>
            <a href="<?php the_permalink(); ?>">
              ...
              <div class="cat">
                ...
                <span class="cat-tag cat-tag-<?php echo $term_id; ?>"><?php single_term_title(); ?></span>
